...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_server_ip.setGeometry(QtCore.QRect(10, 80, 121, 20))
        self.lineEdit_server_ip.setObjectName("lineEdit_server_ip")
        self.lineEdit_server_port = QtWidgets.QLineEdit(self.groupBox_7)
        self.lineEdit_server_port.setGeometry(QtCore.QRect(10, 110, 121, 20))
        ...
        self.pushButton_connect.setGeometry(QtCore.QRect(140, 90, 51, 31))
